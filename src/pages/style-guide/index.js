      ...
      <section className={s.row}>
        ...
        <article className={[s.content, s.post].join(' ')}>
          ...
          <div className={s.post_info}>
            ...
            <time dateTime="2016-09-10" className="is-emph">
September 10, 2016 | by Regina
                          Radium
            </time>
...
Aenean ac quam et risus tincidunt ultrices et sed ligula. Sed
              ...
              <NavLink to={`/post/${id}`} className={s.link_full_post}>
continue
                              reading...
              </NavLink>
            </div>
      ...
      <section className={s.row}>
        ...
        <div className={s.content}>
          <p>
Aenean ac quam et risus tincidunt ultrices et sed ligula. Sed consectetur
...
Duis ligula purus tempus.
      ...
      <section className={s.row}>
        ...
        <div className={s.content}>
          <blockquote>
“Maecenas id ante sed arcu blandit luctus. Duis elit magna, semper non
                      posuere eu,
